...
def generate_launch_description():
    ...
    robot_description_semantic_content = Command(
        [
            ...
            " ",
            PathJoinSubstitution(
                [FindPackageShare(description_package), "srdf", "dual_iiwa.srdf.xacro"]
            ),
            " ",
            "name:=",
            "iiwa",
    ...
    robot_description_planning_joint_limits = PathJoinSubstitution([
            FindPackageShare(description_package), "moveit2", "dual_iiwa_joint_limits.yaml",
        ]
    )

    robot_description_planning_cartesian_limits = PathJoinSubstitution([
            FindPackageShare(description_package), "moveit2", "dual_iiwa_cartesian_limits.yaml",
        ]
    )
    ...
    moveit_controllers = PathJoinSubstitution(
        [FindPackageShare(description_package),
            "moveit2", "dual_iiwa_moveit_controller_config.yaml"]
    )
